...
export default async function handler(req, res) {
  // The native iOS/Android app calls this from a different origin (its local
  // bundle, not wrenched.shop itself), which browsers/WebViews treat as a
  // cross-origin request — without these headers it gets silently blocked
